...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Изграждане на Уеб сайт, Онлайн Магазин, Уеб дизайн и СЕО Оптимизация, Реклама, Маркетинг услуги, изработка до 10 дни</title>
        <meta name="description" content="Изработка на Уебсайт, Онлайн Магазин, СЕО Оптимизация и Реклама. Ние ще се погрижим за дигиталното присъствие на вашият бизнес в интернет. Маркетинг услуги на достъпни цени." />
